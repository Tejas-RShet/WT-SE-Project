      ...
      <div className="md:flex gap-4 py-2">
        <div className="md:w-1/2 ">
          ...
          <h2 className="text-4xl  md:text-7xl font-bold py-4">
            Online
            <span className="text-red-600 "> Grocery Store</span>
          </h2>
          <p className="py-2 text-base ">
            ...
            only five centuries,
            This is text space which is meant to tell a little about the website
            as per the requirements of the shop owner
          </p>
